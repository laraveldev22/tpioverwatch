...
import { Mail, Phone,  Globe, Printer, History } from 'lucide-react';
...
function page() {
    ...
    const id = params.id as string; // 👈 dynamic id
    ...
    const fetchArticles = async () => {
        ...
        try {
            const response = await axios.get(
                `${process.env.NEXT_PUBLIC_API_URL}/newsletters/with-articles/${id}/`,
            );
