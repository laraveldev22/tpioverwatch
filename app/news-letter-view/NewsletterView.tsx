...
function NewsletterView() {
    ...
    const id = searchParams.get("id"); // ✅ get slug from query
    const newsletterId = searchParams.get("newsletterId"); // ✅ get slug from query
    ...
    const fetchArticles = async () => {
        ...
        try {
            ...
            const newsletter = response.data.articles;
             if (!newsletter) {
